...
instance_activate_object(obj_boss_1);
instance_activate_object(obj_boss_2);
instance_activate_object(obj_boss_3);
instance_activate_object(obj_boss_4);
...
if global.boss == 4 {instance_activate_region(view_xview[4]-32,view_yview[4]-32,view_wview[4]+32,view_hview[4]+32,true);}

if global.boss == 1 { instance_activate_object(obj_frog);}

if global.boss == 2 { instance_activate_object(obj_boss);}
if global.boss == 2 { instance_activate_object(obj_minifrog);}

if global.boss == 3 { instance_activate_object(obj_boss_three);}

if global.boss == 4 { instance_activate_object(obj_boss_four);}
if global.boss == 4 { instance_activate_object(obj_eruption);}
if global.boss == 4 { instance_activate_object(obj_magma);}
